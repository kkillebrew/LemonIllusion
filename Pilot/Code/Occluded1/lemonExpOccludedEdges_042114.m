% rawdata(n,1) = top/bot(1) left/right(2)
...
if keyNum == 1
    datadir = '/Users/C-Lab/Google Drive/Lab Projects/Lemon Illusion/Data/Occluded Lemon1/';
elseif keyNum == 2
    datadir = '/Volumes/C-Lab/Google Drive/Lab Projects/Lemon Illusion/Data/Occluded Lemon1/';
end
...
occludedTypeList = [1 2]; %1=top/bottom occluded 2=sides occluded
...
for n=1:4
    ...
    stimTypePrac = [1 1 2 2];
    amountOccludedPrac = [1 4 1 4];
    ...
    if stimTypePrac(n) == 1
        if amountOccludedPrac(n) == 1
            occludedRectTop(1,:) = [x0-(circleSize/2)-10,  y0-(circleSize/2)-distanceOffsetBig-10, x0+(circleSize/2)+10, y0-(circleSize/2)-distanceOffsetBig-5];
            occludedRectBot(1,:) = [x0-(circleSize/2)-10, y0+(circleSize/2)-distanceOffsetBig+5, x0+(circleSize/2)+10, y0+(circleSize/2)-distanceOffsetBig+10];
            Screen('FillRect',w,[backColor backColor backColor],occludedRectTop(1,:));
            Screen('FillRect',w,[backColor backColor backColor],occludedRectBot(1,:));
        elseif amountOccludedPrac(n) == 2
            occludedRectTop(2,:) = [x0-(circleSize/2)-10,  y0-(circleSize/2)-distanceOffsetBig-10, x0+(circleSize/2)+10, y1UL - (y1UL - (y0-(circleSize/2)-distanceOffsetBig))*.66];
            occludedRectBot(2,:) = [x0-(circleSize/2)-10, y1LL + ((y0+(circleSize/2)-distanceOffsetBig)-y1LL)*.66, x0+(circleSize/2)+10, y0+(circleSize/2)-distanceOffsetBig+10];
            Screen('FillRect',w,[backColor backColor backColor],occludedRectTop(2,:));
            Screen('FillRect',w,[backColor backColor backColor],occludedRectBot(2,:));
        elseif amountOccludedPrac(n) == 3
            occludedRectTop(3,:) = [x0-(circleSize/2)-10,  y0-(circleSize/2)-distanceOffsetBig-10, x0+(circleSize/2)+10, y1UL - (y1UL - (y0-(circleSize/2)-distanceOffsetBig))*.33];
            occludedRectBot(3,:) = [x0-(circleSize/2)-10, y1LL + ((y0+(circleSize/2)-distanceOffsetBig)-y1LL)*.33, x0+(circleSize/2)+10, y0+(circleSize/2)-distanceOffsetBig+10];
            Screen('FillRect',w,[backColor backColor backColor],occludedRectTop(3,:));
            Screen('FillRect',w,[backColor backColor backColor],occludedRectBot(3,:));
    ...
    elseif stimTypePrac(n) == 2
        if amountOccludedPrac(n) == 1
            occludedRectLeft(1,:) = [(x0-(smallCircleSize/2))-distanceOffset-10, (y0-(smallCircleSize/2))-10, (x0-(smallCircleSize/2))-distanceOffset-5, (y0+(smallCircleSize/2))+10];
            occludedRectRight(1,:) = [(x0+(smallCircleSize/2))+distanceOffset+5, (y0-(smallCircleSize/2))-10, (x0+(smallCircleSize/2))+distanceOffset+10, (y0+(smallCircleSize/2))+10];
        ...
        elseif amountOccludedPrac(n) == 2
            occludedRectLeft(2,:) = [(x0-(smallCircleSize/2))-distanceOffset-10, (y0-(smallCircleSize/2))-10, x2UL - (x2UL - ((x0-(smallCircleSize/2))-distanceOffset))*.66, (y0+(smallCircleSize/2))+10];
            occludedRectRight(2,:) = [x2UR + (((x0+(smallCircleSize/2))+distanceOffset) - x2UR)*.66, (y0-(smallCircleSize/2))-10, (x0+(smallCircleSize/2))+distanceOffset+10, (y0+(smallCircleSize/2))+10];
        ...
        elseif amountOccludedPrac(n) == 3
            occludedRectLeft(3,:) = [(x0-(smallCircleSize/2))-distanceOffset-10, (y0-(smallCircleSize/2))-10, x2UL - (x2UL - ((x0-(smallCircleSize/2))-distanceOffset))*.33, (y0+(smallCircleSize/2))+10];
            occludedRectRight(3,:) = [x2UR + (((x0+(smallCircleSize/2))+distanceOffset) - x2UR)*.33, (y0-(smallCircleSize/2))-10, (x0+(smallCircleSize/2))+distanceOffset+10, (y0+(smallCircleSize/2))+10];
