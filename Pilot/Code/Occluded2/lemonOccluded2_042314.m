...
if keyNum == 1
    datadir = '/Users/C-Lab/Google Drive/Lab Projects/Lemon Illusion/Data/Occluded Lemon2/';
elseif keyNum == 2
    datadir = '/Volumes/C-Lab/Google Drive/Lab Projects/Lemon Illusion/Data/Occluded Lemon2/';
end
...
for n=1:8
    ...
    stimTypePrac = [4 4 2 2 3 3 4 4];
    amountOccludedPrac = [4 4 1 4 1 4 1 4];
